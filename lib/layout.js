...
Layout = (function() {
  ...
  Layout.prototype.layout = function(images, options) {
	...
	this.restrictAxis = options.restrictAxis || "";
  ...
  Layout.prototype.findNode = function(root, w, h) {
    if (root.used) {
      return (this.restrictAxis === "x" ? this.findNode(root.down, w, h)  : null) || 
	         (this.restrictAxis === "y" ? this.findNode(root.right, w, h) : null) || 
			 (this.restrictAxis === "" ? (this.findNode(root.right, w, h) || this.findNode(root.down, w, h)) : null);
  ...
  Layout.prototype.splitNode = function(node, w, h) {
    ...
    return node[(this.restrictAxis === "x" ? "down" : "right")];
  };
  ...
  Layout.prototype.grow = function(root, w, h) {
    ...
    shouldGrowRight = ((canGrowRight && (root.h >= (root.w + w))) || this.restrictAxis === "y");
    shouldGrowDown = ((canGrowDown && (root.w >= (root.h + h))) || this.restrictAxis === "x");
    if (shouldGrowRight && this.restrictAxis !== "x") {
      return this.growRight(root, w, h);
    } else if (shouldGrowDown && this.restrictAxis !== "y") {
  ...
  Layout.prototype.growRight = function(root, w, h) {
    return {
      ...
      x: 0,
      y: 0,
      w: (this.restrictAxis === "x" ? Math.max(root.w, w) : root.w + w),
      h: root.h,
      down: root,
      right: {
        x: root.w,
  ...
  Layout.prototype.growDown = function(root, w, h) {
    return {
      ...
      y: 0,
      w: root.w,
      h: (this.restrictAxis === "y" ? Math.max(root.h, h) : root.h + h),
      down: {
        x: 0,
        y: root.h,
        w: root.w,
